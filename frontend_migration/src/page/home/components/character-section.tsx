        ...
        <FadeIn direction="left" className="flex max-w-3xl flex-col gap-7">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
              로디(Rody)는 길을 뜻하는 Road와 친구를 뜻하는 Buddy를 합친
              이름입니다. 복지 서비스, 돌봄 기관, 병원, 요양 시설, 지원
              정책처럼 찾기 어려운 정보를 사용자가 이해하기 쉬운 말로 바꾸고,
              필요한 장소와 절차를 차근차근 안내합니다.
            </p>
            <p className="mt-3 max-w-2xl text-pretty text-base leading-relaxed text-muted-foreground">
              로디가 강아지인 이유는 친근한 동반자처럼 옆에서 기다려주고,
              헷갈리는 순간에 방향을 알려주는 이미지를 담기 위해서입니다.
            </p>
          </div>
